...
from ps_challenge.controller import (
    ...
    get_user_completed_percentages,
...
class TestController(TestCase):
    ...
    @patch("ps_challenge.controller.get_game_achievements")
    def test_get_user_completed_percentages_bronze(self, get_achieve_mock):
        ...
        result = get_user_completed_percentages(
    ...
    @patch("ps_challenge.controller.get_game_achievements")
    def test_get_user_completed_percentages_silver(self, get_achieve_mock):
        get_achieve_mock.side_effect = generate_mock_achievement_list_json(
    ...
    @patch("ps_challenge.controller.get_game_achievements")
    def test_get_user_completed_percentages_404(self, get_achieve_mock):
        get_achieve_mock.side_effect = UserDataNotFoundError("", 404)
        with self.assertRaises(UserDataNotFoundError) as error:
            get_user_completed_percentages(none_lib["user"], none_lib["ownedGames"])
